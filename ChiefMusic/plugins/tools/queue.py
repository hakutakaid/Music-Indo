...
from ChiefMusic import app, Platform
from ChiefMusic.misc import db
from ChiefMusic.utils import Yukkibin, get_channeplayCB, seconds_to_min
from ChiefMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from ChiefMusic.utils.decorators.language import language, languageCB
from ChiefMusic.utils.inline.queue import queue_back_markup, queue_markup
