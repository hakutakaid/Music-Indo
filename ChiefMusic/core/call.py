...
from ChiefMusic import LOGGER, Platform, app, userbot
from ChiefMusic.misc import db
...
from ChiefMusic.utils.exceptions import AssistantErr
from ChiefMusic.utils.inline.play import stream_markup, telegram_markup
from ChiefMusic.utils.stream.autoclear import auto_clean
from ChiefMusic.utils.thumbnails import gen_thumb
...
class Call:
    ...
    async def stream_call(self, link):
        assistant = await group_assistant(self, LOG_GROUP_ID)
        call_config = GroupCallConfig(auto_start=False)
        ...
        await assistant.leave_call(LOG_GROUP_ID)
