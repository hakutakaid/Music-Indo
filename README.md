...
<h4>Click the button below to deploy Cey Music Bot on Heroku!</h4>    
...
- These are the minimum required vars need to setup to make Cey Music Bot functional.
...
7. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@CeyStringBot](http://t.me/) in Telegram.
...
- You can play tracks or playlists from spotify from Cey Music bot
- You'll need these two vars to make spotify play working. This is not essential , you can leave them blank if you want.

### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/Ceymusicbot/deployment/spotify)
...
- If you plan to use Cey Music Bot with your own customized or modified code.
